 ...
 */
public class CategoryRecyclerAdapter extends RealmRecyclerViewAdapter<Category> {
    //extends RecyclerView.Adapter<CategoryRecyclerAdapter.CategoryViewHolder> {
...
//    }
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            recyclerViewListener.onItemClickListener(v, getItem(position));
        }
    }
}
